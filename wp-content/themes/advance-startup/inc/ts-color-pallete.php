...
/*---------------------------Theme color option-------------------*/
	...
	$advance_startup_loader_background_color_settings = get_theme_mod('advance_startup_loader_background_color_settings');
	$advance_startup_custom_css .='#loader-wrapper .loader-section{';
		$advance_startup_custom_css .='background-color: '.esc_attr($advance_startup_loader_background_color_settings).';';
	$advance_startup_custom_css .='} ';