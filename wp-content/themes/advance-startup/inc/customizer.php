...
function advance_startup_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting( 'advance_startup_loader_background_color_settings', array(
	    'default' => '#222',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'advance_startup_loader_background_color_settings', array(
  		'label' => __('Preloader Background Color', 'advance-startup'),
	    'section' => 'advance_startup_left_right',
	    'settings' => 'advance_startup_loader_background_color_settings',
  	)));
    ...
    $wp_customize->add_setting('advance_startup_slider_title_Show_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_startup_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_startup_slider_title_Show_hide',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Slider Title','advance-startup'),
       'section' => 'advance_startup_slider'
    ));

    $wp_customize->add_setting('advance_startup_slider_content_Show_hide',array(
       'default' => true,
       'sanitize_callback'	=> 'advance_startup_sanitize_checkbox'
    ));
    $wp_customize->add_control('advance_startup_slider_content_Show_hide',array(
       'type' => 'checkbox',
       'label' => __('Show / Hide Slider Content','advance-startup'),
       'section' => 'advance_startup_slider'
    ));
	...
	$wp_customize->add_setting( 'advance_startup_category_button_text', array(
		'default'   => __('VIEW DETAILS','advance-startup' ),
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control( 'advance_startup_category_button_text', array(
		'label'    => __( 'Category Post Button text','advance-startup' ),
		'section'  => 'advance_startup_category',
		'type'     => 'text',
		'settings' => 'advance_startup_category_button_text'
	) );
    ...
    $wp_customize->add_setting( 'advance_startup_show_related_post',array(
		'default' => true,
      	'sanitize_callback'	=> 'advance_startup_sanitize_checkbox'
    ) );
    $wp_customize->add_control('advance_startup_show_related_post',array(
    	'type' => 'checkbox',
        'label' => __( 'Related Post','advance-startup' ),
        'section' => 'advance_startup_blog_post'
    ));

    $wp_customize->add_setting('advance_startup_related_posts_taxanomies_options',array(
        'default' => 'categories',
        'sanitize_callback' => 'advance_startup_sanitize_choices'
	));
	$wp_customize->add_control('advance_startup_related_posts_taxanomies_options',array(
        'type' => 'radio',
        'label' => __('Related Post Taxonomies','advance-startup'),
        'section' => 'advance_startup_blog_post',
        'choices' => array(
            'categories' => __('Categories','advance-startup'),
            'tags' => __('Tags','advance-startup'),
        ),
	) );

	$wp_customize->add_setting('advance_startup_related_post_title',array(
		'default'=> __('Related Posts','advance-startup'),
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control('advance_startup_related_post_title',array(
		'label'	=> __('Related Post Title','advance-startup'),
		'section'=> 'advance_startup_blog_post',
		'type'=> 'text'
	));

   	$wp_customize->add_setting('advance_startup_related_posts_number',array(
		'default'=> 3,
		'sanitize_callback'	=> 'advance_startup_sanitize_float',
	));
	$wp_customize->add_control('advance_startup_related_posts_number',array(
		'label'	=> __('Related Post Number','advance-startup'),
		'section'=> 'advance_startup_blog_post',
		'type'=> 'number',
		'input_attrs' => array(
            'step'             => 1,
...
if ( ! defined( 'PRO_THEME_LINK' ) ) {
	define( 'PRO_THEME_LINK', 'https://www.themeshopy.com/themes/startup-wordpress-theme/' );
}
if ( ! defined( 'PRO_THEME_TEXT' ) ) {
	define( 'PRO_THEME_TEXT', __('Startup Pro Theme','advance-startup') );
}
