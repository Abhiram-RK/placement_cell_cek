                    ...
                    <div class="cat_body mb-2">
                      ...
                      <div class="theme_button my-2 mx-0">
                        <?php if( get_theme_mod('advance_startup_category_button_text','VIEW DETAILS') != ''){ ?>
                          <a href="<?php the_permalink(); ?>"><?php echo esc_html( get_theme_mod('advance_startup_category_button_text',__('VIEW DETAILS', 'advance-startup')) ); ?><i class="fas fa-angle-right ms-2"></i><span class="screen-reader-text"><?php echo esc_html( get_theme_mod('advance_startup_category_button_text',__('VIEW DETAILS', 'advance-startup')) ); ?></span>
                          </a>
                        <?php } ?>
                      </div>
                    </div>
